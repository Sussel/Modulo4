...
public class MyStepdefs {
    ...
    public void iExpectedTheResponseCode(int expectedResponseCode) {
        ...
        Assert.assertEquals("ERROR !! the response code is not correct", expectedResponseCode, response.getResponseCode());
    }
    ...
    public void iExpectedTheResponseBodyIsEqual(String expectedResponseBody) throws JSONException {
        ...
        Assert.assertTrue("ERROR the response body is not correct", JsonHelper.areEqualJSON(this.replaceVariables(expectedResponseBody), response.getResponseBody()));
    }
